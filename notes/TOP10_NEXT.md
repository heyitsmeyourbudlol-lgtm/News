...
- **Measured (scoreboard 04:09Z):** peer+improve **active**; Active nonempty; **4 today · proj 23.0/day · week_avg 4.0 [GAP]** — `meets_bar=false` (need today≥8 observed; proj alone cannot PASS). Do **not** false-close. Scoreboard meters CLEAN only (Mac sidecar no longer inflates).
